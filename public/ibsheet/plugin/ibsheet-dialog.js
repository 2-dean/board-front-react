  ...
  if (this.tag) {
    ...
    if (org && this.orgTag && this.orgTag.parentNode && this.orgTag.parentNode) {
      ...
      if (parent.childNodes.length == 0) {
        parent.innerHTML = "<i class='CellsInfo' style='color:gray;font-size:12px;'>" + T.Lang.Dialog.DragHere + "</i>";
      }
      this.orgTag = null;
    }
  }
...
DOP.MakeDragObj = function (object, ev) {
  ...
  this.tag = div;
  this.orgTag = object;
  if (ev.target && ev.target.childNodes[1]) {
    var orgSel = document.getElementsByName(ev.target.childNodes[1].name)[0];
...
Fn.showChartDialog = function (chartType, extraOpt) {
  ...
  **/
  ...
  + "        <button  type='button' onclick=\"DLG.moveTab('tab1')\" class='active'>"+this.Lang.Dialog.ChartTypes+"</button>"
        +"</li>"
        +"<li class='"+classPrefix+"ChartTab' id='tab2'>"
        +"  <button type='button' onclick=\"DLG.moveTab('tab2')\">"+this.Lang.Dialog.ChartData+"</button>"
        +"</li>"
        +"<li class='"+classPrefix+"ChartTab' id='tab3'>"
        +"  <button  type='button' onclick=\"DLG.moveTab('tab3')\">"+this.Lang.Dialog.Config+"</button>"
  +"      </li>"
  +"    </ul>"
  ...
  +"    </div>"
  +"    <div class='"+classPrefix+"ChartAccItem'>"
  +"      <div class='"+classPrefix+"ChartAccHeader'>"+this.Lang.Dialog.Datas+"<div class='"+classPrefix+"ChartAccHeaderToggle'><label for='_allData'>"+this.Lang.Dialog.SelectAll+"<span class='_toggle'></span></ label><input type='checkbox' onclick='DLG.chgChart()' id='_allData'></div></div>"
  ...
  extraBtn.innerHTML = 
  "<button type='button' onclick='DLG.downBtnToggle()' ontouchend='DLG.excelDown()' class='toggleDown' title='"+ this.Lang.Dialog.FileDownload  +"'></button>"
  +"<button type='button' class='btnDown' onclick='DLG.imageDown()' title='" + this.Lang.Dialog.PngDown + "'>.png</button>"
  +"<button type='button' class='btnDown' onclick='DLG.excelDown()' title='" + this.Lang.Dialog.XlsxDown + "'>.xlsx</button>"
  +"<button type='button' onclick='DLG.toggleConfigShow()' ontouchend='DLG.toggleConfigShow()' class='Config' title='"+ this.Lang.Dialog.Config +"'></button>"
  +"<button type='button' onclick='DLG.zoomInOut()' ontouchend='DLG.zoomInOut()' class='Zoom' title='"+ this.Lang.Dialog.Zoom +"'></button>"
...
Fn.DialogButtonsConfig = function(DLG) {
  ...
  DLG.makeTab2 = function(isNew){
    ...
    var CATEGORY = ["<li><input type='radio' name='category' id='_none'  onclick='DLG.chgChart()' ><label for='_none'>"+this.sheet.Lang.Dialog.None+"</label></li>"];
    var selectedCols;
    if(!isNew) {
    ...
    "<div class='" + themePrefix + "FindDlgWrap' style='padding-left: 8px;'>" + 
      "<div class='" + themePrefix + "FindDlgTop' style='width:94.7%;display:flex;justify-content:space-between;' onkeyup='" + sheetId + ".findDlgFunc(\"outKeyUp\", event)'>" +
        "<div style='border-radius:3px;'>" + 
          "<input type='text' style='border:0px;outline:none;' id='" + sheetId + "_FindTxt' onkeyup='" + sheetId + ".findDlgFunc(\"FindKeyUp\", event)' title='"+this.Lang.Dialog.EnterSearchTerm+"' placeholder='"+this.Lang.Dialog.EnterSearchTerm+"' autocomplete='off'/><span></span>" + 
        "</div>" +
        "<div style='margin-left:65px;'>" + 
          "<button type='button' tabindex='-1' class='" + btnClass + "' onclick='" + sheetId + ".findDlgFunc(\"FindPrev\", event)' title='"+this.Lang.Dialog.FindPrev+"'>↑</button>" +
          "<button type='button' tabindex='-1' class='" + btnClass + "' onclick='" + sheetId + ".findDlgFunc( \"Find\", event)' title='"+this.Lang.Dialog.FindNext+"'>↓</button>" + 
          "<button type='button' tabindex='-1' class='" + btnClass + "' onclick='" + sheetId + ".findReplaceOpen(event)' title='"+this.Lang.Dialog.Replace+"'>＋</button>" + 
        "</div>" + 
      "</div>" +
      "<div class='" + themePrefix + "FindDlgTop' id='fidDlgTopLayer_2' style='display:none;important;width:94.7%;justify-content:space-between;padding-top:0px;' onkeyup='" + sheetId + ".findDlgFunc(\"outKeyUp\", event)'>" +
        "<div id='sheet_edit_input_div' style='display:none;margin-top:5px;border-radius:3px;'>" + 
          "<input type='text' style='border:0px;outline:none;' id='" + sheetId + "_ReplaceTxt' onkeyup='" + sheetId + ".findDlgFunc(\"ReplaceKeyUp\", event)'  title='"+this.Lang.Dialog.EnterReplaceWord+"' placeholder='"+this.Lang.Dialog.EnterReplaceWord+"' autocomplete='off'/>" + 
        "</div>" + 
        "<div id='replace_button_div' style='display:none;margin-top:5px;border-radius:3px;'>" + 
          "<button id='replace_sheet_dialog_btn' type='button' style='visibility:hidden;background:cornflowerblue;margin-top:1px;' class='" + btnClass + "' onclick='" + sheetId + ".findDlgFunc(\"Replace\", event)'>" + this.Lang.Dialog.Replace + "</button>" +
          "<button id='replace_all_sheet_dialog_btn' type='button' style='visibility:hidden;background:cornflowerblue;margin-top:1px;' class='" + btnClass + "' onclick='" + sheetId + ".findDlgFunc(\"ReplaceAll\", event)'>" + this.Lang.Dialog.ReplaceAll + "</button>" +
        "</div>" +
      "</div>" +
      ...
      "<div class='" + themePrefix + "FindDlgBottom'  onkeyup='" + sheetId + ".findDlgFunc(\"outKeyUp\", event)'>" + 
        "<div class='" + themePrefix + "S_FIND_CASE' style='margin-bottom:10px;width:94.7%;display:flex;justify-content:space-between;height:50px;position:relative;'>" +
          "<div>" + 
            "<input type='checkbox' id='" + sheetId + "_FindChk' " + checked1 + " onchange='" + sheetId + ".findDlgFunc(\"ChgCaseSense\", event)' /><label for='" + sheetId + "_FindChk'>"+this.Lang.Dialog.CaseSensitive+"</label>" +
            "<input type='checkbox' id='" + sheetId + "_ContentMatchChk' " + checked2 + " onchange='" + sheetId + ".findDlgFunc(\"ContentMatch\", event)' /><label for='" + sheetId + "_ContentMatchChk'>"+this.Lang.Dialog.MatchEntireContent+"</label>" +
            "<label for='" + sheetId + "_IncludeCantEdit' id='include_cant_edit_wrap' style='position:absolute;left:0.1%;top:45%;display:none;'><input type='checkbox' id='" + sheetId + "_IncludeCantEdit' " + checked2 + " onchange='" + sheetId + ".findDlgFunc(\"IncludeCantEdit\", event)'/>"+this.Lang.Dialog.IncludeCanNotEdit+"</label>" +
          "</div>" +
          "<div>" +
            "<button type='button' class='" + btnClass + "' onclick='" + sheetId + ".findDlgFunc(\"Mark\", event)' style='background:darkcyan;'>"+this.Lang.Text.SearchMark+"</button>" +
            "<button type='button' class='" + btnClass + "' onclick='" + sheetId + ".findDlgFunc(\"Select\", event)' style='background:darkcyan; '>"+this.Lang.Text.SearchSelect+"</button>" +
            "<button type='button' class='" + btnClass + "' onclick='" + sheetId + ".findDlgFunc(\"Clear\", event)' style='background:darkcyan;'>"+this.Lang.Dialog.UnCheck+"</button>" + 
          "</div>" +
        "</div>" +
        ...
        "<div class='" + themePrefix + "S_FIND_BTN' style='width:94.7%;position:relative;display:flex;justify-content:space-between;'>" +
          ...
          "<button type='button' tabindex='-1' class='" + btnClass + "' onclick='" + sheetId + ".findDlgFunc( \"FindAll\", event)' title='"+this.Lang.Dialog.FindAll+"'>"+this.Lang.Dialog.FindAll+"</button>" + 
        "</div>" + 
        "<div style='clear:both;'></div>" + 
      "</div>" + 
...
Fn.showPivotDialog = function (width, height, name, pivotParams, useStorage) {
  ...
  styles.innerHTML = "" +
    ...
    "." + name + "_btns { " +
    "  text-align:right; " +
    "  background-color: #e4f5fd; padding-top: 15px; " +
    "} " +
    "." + name + "_btns > input { " +
    "  height: 13px; " +
    "  margin-right: 3px; " +
  ...
  var switchSheet = "";
  if(this.PivotSheet){
    if(IBSheet[this.PivotSheet.Index] && IBSheet[this.PivotSheet.Index].MainTag && self.PivotSheet.MainTag.style.display == "none") switchSheet = "<button id= " + name + "_switchToPivot>"+this.Lang.Dialog.ShowPivot+"</button>";
    else if(self.MainTag.style.display == "none") switchSheet = "<button id= " + name + "_switchToSheet>"+this.Lang.Dialog.ShowOrgSheet+"</button>";
  }

  dialogOpt.Body = "<div class='" + themePrefix + classDlg + "' style='width:" + width + "px;height:" + height + "px;' onkeyup='" + this.id + ".closePivotDialog(event)' onmouseup='" + this.id + ".PivotDragMouseUp(event)' onmousemove='" + this.id + ".PivotDragMouseMove(event)'>" +
    "<div>" +
    ...
    "<div id='" + name + "_NumberCols' class='" + this.Style + "PivotStandards' style='overflow-y:auto; height:calc(100% - 46px);padding:7px;' onselectstart='return false;' onmouseup='" + this.id + ".PivotDragSetItem(this,event)'> " +
    pivotCols[1] +
    "</div>" +
    "</div>" +
    "</div>" +
    ...
    (pivotCols[2] ? pivotCols[2] : "<i class='CellsInfo' style='color:gray;font-size:12px;'>"+this.Lang.Dialog.DragHere+"</i>") +
    "</div>" +
    "</div>" +
    "<div style='height:33%'>" +
    ...
    (pivotCols[3] ? pivotCols[3] : "<i class='CellsInfo' style='color:gray;font-size:12px;'>"+this.Lang.Dialog.DragHere+"</i>") +
    "</div>" +
    "</div>" +
    "<div style='height:34%'>" +
    ...
    (pivotCols[4] ? pivotCols[4] : "<i class='CellsInfo' style='color:gray;font-size:12px;'>"+this.Lang.Dialog.DragHere+"</i>") +
    "</div>" +
    "</div>" +
    "</div>" +
    "</div>" +
    "<div class='" + name + "_btns'>" +
      (useStorage ? "<label for=\'" + name + "_saveStorage\'><input type=\'checkbox\' id=\'" + name + "_saveStorage\'" + (saveInfo ? " checked " : "") + ">"+this.Lang.Dialog.SavePivotConfig+"</label>" : "") +
      "<button id='" + name + "_clearPivotBtn'>"+this.Lang.Dialog.Reset+"</button>" + switchSheet + "<button id='" + name + "_createPivotBtn'>"+this.Lang.Dialog.CreatePivot+"</button><button id='" + name + "_cancelBtn'>"+this.Lang.MenuButtons.Cancel+"</button></div>" +
    "</div>";
  ...
  btnCreate.onclick = function () {
    ...
    for (var k = 0; k < targetPData.length; k++) {
      pivotType.push(document.getElementsByName(targetPData[k])[0].value);
    }
    ...
    if (targetPRow.length === 0 || targetPCol.length === 0 || targetPData.length === 0) {
      self.alert(self.Lang.Dialog.NotComplete);
      return false;
    }
...
Fn.findPivotColumn = function () {
  ...
  var cols = this.getCols().filter(function (col) {
    return col !== "SEQ" && this.Cols[col].Type !== "Button" && this.Cols[col].Type !== "Img" && this.Cols[col].Type !== "Bool";
  }.bind(this));
  for (var i = 0; i < cols.length; i++) {
...
Fn.PivotDragSetItem = function (object, ev) {
  if (drag.tag) {
    ...
    var fndColName = this.findPivotColumn();
    var fromDragTagName = drag.tag.firstChild.firstChild.getAttribute("colname");

    if (object.id.indexOf("_NomalCols") != -1) {
      for (var k = 0; k < fndColName.number.length; k++) {
        if (fndColName.number[k].Name == fromDragTagName) {
          alert(this.Lang.Dialog.WrongTypeWarn);
          return false;
        }
      }
    } else if (object.id.indexOf("NumberCols") != -1) {
      for (var k = 0; k < fndColName.common.length; k++) {
        if (fndColName.common[k].Name == fromDragTagName) {
          alert(this.Lang.Dialog.WrongTypeWarn);
          return false;
        }
      }
...
Fn.producePivotColumn = function () {
  ...
  if (cols.common && cols.common.length > 0) {
    ...
    for (var i = 0; i < arPivotRows.length; i++) {
      _IBSheet.__.find(cols.common, function (v){
        if (v.Name == arPivotRows[i]) {
          strCols = "<span onmousedown='" + T.id + ".PivotItemClick(this,event);' ontouchstart='" + T.id + ".PivotItemClick(this,event);'><b class='box' colName='" + v.Name + "'>" + v.Value + makeSelString(v.Name, i, 'normal') +  "</b></span>";
    ...
    for (var i = 0; i < cols.common.length; i++) {
      strCols = "<span onmousedown='" + this.id + ".PivotItemClick(this,event);' ontouchstart='" + this.id + ".PivotItemClick(this,event);'><b class='box' colName='" + cols.common[i].Name + "'>" + cols.common[i].Value + makeSelString(cols.common[i].Name, i, 'normal') +"</b></span>";
      ...
      if (!((this.PivotRows && this.PivotRows.indexOf(cols.common[i].Name) > -1) || (!this.PivotRows && this.InitPivotRows && this.InitPivotRows.indexOf(cols.common[i].Name) > -1)) &&
        ...
        !((this.PivotData && this.PivotData.indexOf(cols.common[i].Name) > -1) || (!this.PivotData && this.InitPivotData && this.InitPivotData.indexOf(cols.common[i].Name) > -1))
      ) {
        strCommon += strCols;
      }
    }
  ...
  function makeSelString (cName, idx, category) {
    ...
    var res = "";
    if (category == "num") {
      res += "<select tabindex='-1' style='font-size:10px; margin-left:3px; margin-right:-5px;' name='" + cName + "'>";
      ...
      res += "<select tabindex='-1' style='display:none;' name='" + cName + "'>";
      res +=  "<option style='font-size:10px;' value='Count'" + getOptSelected('Count') + ">" + T["Lang"]["Text"]["PivotCount"] + "</option>";
      res += "</select>";
    }
    return res;
  ...
  if (cols.number && cols.number.length > 0) {
    ...
    for (var i = 0; i < arPivotRows.length; i++) {
      _IBSheet.__.find(cols.number, function (v){
        if (v.Name == arPivotRows[i]) {
          strCols = "<span onmousedown='" + T.id + ".PivotItemClick(this,event);' ontouchstart='" + T.id + ".PivotItemClick(this,event);'><b class='box' colName='" + v.Name + "'>" + v.Value + makeSelString(v.Name, i, 'num') +  "</b></span>";
          strPivotRows += strCols;
        }
      });
    }
    ...
    for (var i = 0; i < cols.number.length; i++) {
      strCols = "<span style='z-index:0;' onmousedown='" + this.id + ".PivotItemClick(this,event);' ontouchstart='" + this.id + ".PivotItemClick(this,event);'><b class='box' colName='" + cols.number[i].Name + "'>" + cols.number[i].Value + makeSelString(cols.number[i].Name, '', 'num') + "</b></span>";
      ...
      if (!((this.PivotData && this.PivotData.indexOf(cols.number[i].Name) > -1) || (!this.PivotData && this.InitPivotData && this.InitPivotData.indexOf(cols.number[i].Name) > -1)) &&
        !((this.PivotRows && this.PivotRows.indexOf(cols.number[i].Name) > -1) || (!this.PivotRows && this.InitPivotRows && this.InitPivotRows.indexOf(cols.number[i].Name) > -1)) &&
        !((this.PivotCols && this.PivotCols.indexOf(cols.number[i].Name) > -1) || (!this.PivotCols && this.InitPivotCols && this.InitPivotCols.indexOf(cols.number[i].Name) > -1))
      ) {
        strNum += strCols;
      }
    }
